...
public class CageSelectCmd extends Command {
  ...
  public static final Pose2d INNER_CAGE_RED =
      new Pose2d(9.786, 3.02, Rotation2d.fromDegrees(90.0));
  ...
  public void initialize() {
    if (ally.isPresent()) {
      ...
      Pose2d targetPose;
      switch (cageId) {
        case 0 -> targetPose = (team == DriverStation.Alliance.Red) ? OUTER_CAGE_RED : OUTER_CAGE_BLUE;
        case 1 -> targetPose = (team == DriverStation.Alliance.Red) ? MIDDLE_CAGE_RED : MIDDLE_CAGE_BLUE;
        case 2 -> targetPose = (team == DriverStation.Alliance.Red) ? INNER_CAGE_RED : INNER_CAGE_BLUE;

...
public class SingleTagAdjustment {
  ...
  /**
   * Optionally, use this map to store "overrides" at runtime. If you don’t need
   * runtime changes,
  ...
  /**
   * Gets the current adjustment for the specified tag. - If there's a dynamic
   * override in
   * DYNAMIC_ADJUSTMENTS, use it. - Otherwise, fall back to
   * DEFAULT_TAG_ADJUSTMENTS (using tagId - 1
  ...
  /**
   * Allows you to set (or override) the adjustment for a given tag at runtime. If
   * you don't need
   * runtime adjustments, you can remove this method and the DYNAMIC_ADJUSTMENTS
   * map.
   */
